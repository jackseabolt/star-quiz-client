        ...
        return ( 
            <div className="board"> 
                <div className="board-container">
                    <div className="board-post" id="mercury" onClick={() => this.props.dispatch(getNewQuiz('Mercury'))}> 
                        <img className="board-post-image" alt="planet" src={require('../../images/mercury.jpg')} />
                    </div>
                    <div className="board-post" id="venus" onClick={() => this.props.dispatch(getNewQuiz('Venus'))}> 
                        <img className="board-post-image" alt="planet" src={require('../../images/venus.jpg')} />
                    </div>
                    <div className="board-post" id="earth" onClick={() => this.props.dispatch(getNewQuiz('Earth'))}> 
                        <img className="board-post-image" alt="planet" src={require('../../images/earth.jpg')} />
                    </div>
                    <div className="board-post" id="mars" onClick={() => this.props.dispatch(getNewQuiz('Mars'))}> 
                        <img className="board-post-image" alt="planet" src={require('../../images/mars.jpg')} />
                    </div>
                    <div className="board-post" id="jupiter" onClick={() => this.props.dispatch(getNewQuiz('Jupiter'))}> 
                        <img className="board-post-image" alt="planet" src={require('../../images/jupiter.jpg')} />
                    </div>
                    <div className="board-post" id="saturn" onClick={() => this.props.dispatch(getNewQuiz('Saturn'))}> 
                        <img className="board-post-image" alt="planet" src={require('../../images/saturn.jpg')} />
                    </div>
                    <div className="board-post" id="uranus" onClick={() => this.props.dispatch(getNewQuiz('Uranus'))}> 
                        <img className="board-post-image" alt="planet" src={require('../../images/uranus.jpg')} />
                    </div>
                    <div className="board-post" id="neptune" onClick={() => this.props.dispatch(getNewQuiz('Neptune'))}> 
